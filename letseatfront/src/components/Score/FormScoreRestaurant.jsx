...
const UrlNewScore = "https://lets-eat.somee.com/api/Score/Busines"

export default function FormScoreRestaurant ({ idRestaurant, rol, singUp, setShowFormScore, showFormScore, setShowFormScore1Time, showFormScore1Time, showFormNewComment, setShowFormNewComment }) {
  const scoreName = "score";
  const [score, setScore] = useState({
        score: 0,
        businessId: idRestaurant
      })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          // setShowFormScore1Time(!showFormScore1Time)
          Swal.fire(
            'Gracias!',
